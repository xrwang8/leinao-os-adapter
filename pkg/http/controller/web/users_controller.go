...
import (
	...
	"leinao-os-adapter/pkg/model"
	"leinao-os-adapter/pkg/service/users/curd"
	userstoken "leinao-os-adapter/pkg/service/users/token"
...
// 您也可以参考 Admin 项目地址：https://gitee.com/daitougege/gin-skeleton-admin-backend/ 中， pkg/model/  提供的示例语法
