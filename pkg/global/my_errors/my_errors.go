...
const (
	...
	ErrorsConfigYamlNotExists       string = "leinao-os-adapter.yml 配置文件不存在"
	...
	ErrorsGormDBUpdateParamsNotPtr string = "gorm 的 Update、Save 函数的参数必须是一个指针(leinao-os-adapter≥ v1.5.29 版本新增验证，为了完美支持 gorm 的所有回调函数,请在参数前面添加 & )"
	//redis部分
